...
public class GamePanel extends JPanel implements Runnable, MouseListener {
    ...
    public void startGameThread() {
        ...
        showAtomButton = new ShowAtomButton(
                new Vector2D((screenWidth - 150) / 2.0, screenHeight - screenHeight / 10.0 + 40));
        showAtomButton.addMouseListener(this);
        this.add(showAtomButton);

        showRayButton = new ShowRayButton(new Vector2D((screenWidth - 150) / 2.0 + showAtomButton.width + 2,
                screenHeight - screenHeight / 10.0 + 40));
